...
Paystack and Flutterwave are the dominant gateways in Nigeria. Both support card payments, bank transfers, USSD, and mobile money. Both handle settlement â€” moving funds from the customer's bank to your business account.
...
The development team receives API keys from the gateway â€” a public key for the frontend and a secret key for the backend. These keys authenticate your web app's communication with the gateway.
...
Transaction fees affect your margins. Paystack charges 1.5% plus â‚¦100 per transaction. Flutterwave charges a similar rate. Confirm the exact fees and how they affect your pricing.
