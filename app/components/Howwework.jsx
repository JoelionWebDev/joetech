      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="hidden lg:block mb-16">
          <div className="relative">
            ...
            <div
              className="absolute top-24 left-0 h-0.5 bg-blue-500 z-10 transition-all duration-1000 ease-out"
              style={{
                width: `${(visibleSteps.size / processSteps.length) * 100}%`,
              }}
            ></div>
            ...
            <div className="grid grid-cols-4 gap-8 relative z-20">
              {processSteps.map((step, index) => (
                <article
                  ...
                  style={{
                    transitionDelay: visibleSteps.has(index)
                      ? `${index * 200}ms`
                      : "0ms",
                  }}
                >
                  {/* Step Icon Circle */}
                  <div
                    className={`w-16 h-16 rounded-full ${step.color} text-white flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg`}
                  >
        ...
        <div className="lg:hidden space-y-8">
          {processSteps.map((step, index) => (
            <article
              ...
              ref={(el) => (stepRefs.current[index] = el)}
              data-index={index}
              className={`bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-500 overflow-hidden ${
                visibleSteps.has(index)
            ...
            >
              <div className="p-6 sm:p-8 flex items-start space-x-4">
                {/* Step Icon */}
                <div
                  className={`w-12 h-12 sm:w-16 sm:h-16 rounded-full ${step.color} text-white flex items-center justify-center flex-shrink-0 shadow-lg`}
                >
                  <div aria-label={`Step ${step.number}: ${step.title}`}>
                    {step.icon}
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Efficient process ensures timely project completion without
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Rigorous testing and review at each step guarantees
                  exceptional results.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  Transparent communication and collaboration throughout every
                  project phase.
                </p>
              </div>
            </div>
