...
const CTABanner = () => {
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-1/4 w-16 h-16 bg-blue-400/10 rounded-full blur-lg" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center md:text-left max-w-4xl">
          ...
          <div className="flex justify-center md:justify-start">
            <ClientButton
              ariaLabel="Book a free consultation with Joetech to discuss your business needs"
